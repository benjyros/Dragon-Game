...
{
    public partial class highscore_listNormal : Form
    {
        string baseRoute = "";
        string highscoreListNormal = "";

        string[] stringArray;

        public highscore_listNormal()
        {
            InitializeComponent();
            Get_Routes();
            Set_HighscoreList();
        ...
        private void Get_Routes()
        {
            ...
            highscoreListNormal = baseRoute + @"\settings\highscorelist-normal.txt";
        }

        private void Set_HighscoreList()
        {
            //Reading highscore-list file (.txt)
            string[] zeilen = File.ReadAllLines(highscoreListNormal);
        ...
        private void highscore_listNormal_FormClosing(object sender, FormClosingEventArgs e)
        {
