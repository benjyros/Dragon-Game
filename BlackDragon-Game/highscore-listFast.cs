...
{
    public partial class highscore_listFast : Form
    {
        string baseRoute = "";
        string highscoreListFast = "";

        string[] stringArray;

        public highscore_listFast()
        {
            InitializeComponent();
            Get_Routes();
            Set_HighscoreList();
        ...
        private void Get_Routes()
        {
            ...
            highscoreListFast = baseRoute + @"\settings\highscorelist-fast.txt";
        }

        private void Set_HighscoreList()
        {
            //Reading highscore-list file (.txt)
            string[] zeilen = File.ReadAllLines(highscoreListFast);
        ...
        private void highscore_list_FormClosing(object sender, FormClosingEventArgs e)
        {
